...
def member():
    while True:
            ...
            text = font.render("mashunami",True,(255,255,255))
            screen.blit(text,[250,100])
            text2 = font.render("TIGA",True,(255,255,255))
            screen.blit(text2,[250,150])
            text3 = font.render("Kx47g",True,(255,255,255))
            screen.blit(text3,[250,200])
            text4 = font.render("Dorakiya",True,(255,255,255))
            screen.blit(text4,[250,250])
            text5 = font.render("制作メンバー",True,(255,255,255))
...
def battle():
    ...
    while True:
        ...
        text3 = font.render("3 回復薬",True,(255,255,255))
        screen.blit(text3,[505,430])
        pygame.display.update()
        for event in pygame.event.get():
            if playerstatas.HP <= 0:
                gameover()
            if event.type == QUIT:
                pygame.quit()
                sys.exit()
            if event.type == KEYDOWN:
                ...
                if event.key == K_1:
                    ...
                    if monsterstatas.HP <= 0:
                      playerstatas.money += monsterstatas.money
                      while True:
                        for event in pygame.event.get():
                          if event.type == QUIT:
                            pygame.quit()
                ...
                if event.key == K_3:
                        ...
                        if potion < 0:
                            potion = 0
                            text4 = font.render("回復薬を持っていない…",True,(255,255,255))
                            screen.blit(text4,[25,370])
                            pygame.display.update()
                            time.sleep(1)

                        else:
                          text4 = font.render("回復薬の効果でHP20回復！",True,(255,255,255))
                          screen.blit(text4,[25,370])
                          pygame.display.update()
                          time.sleep(1)
                          playerstatas.HP += 20
...
def shop_w():
    ...
    while True:
        ...
        for event in pygame.event.get():
          ...
          if event.type == KEYDOWN:
            if event.key == K_SPACE:
              pygame.draw.rect(screen, (0,0,0), (20,20,240,60))
              text2 = font.render("所持金",True,(255,255,255),30)
              screen.blit(text2,[25,25])
              text3 = font.render(MONEY,True,(255,255,255),30)
              screen.blit(text3,[125,25])
              text4 = font.render("G",True,(255,255,255),30)
              screen.blit(text4,[225,25])
              pygame.draw.rect(screen, (0,0,0), (20,125,400,140))
              text=font.render("1 木の剣 +5 50G",True,(255,255,255),30)
              screen.blit(text,[25,130])
              text2=font.render("2 名刀・斬鉄 +10 200G",True,(255,255,255),30)
              screen.blit(text2,[25,170])
              text3=font.render("3 フラガラッハ +20 1000G",True,(255,255,255),30)
              screen.blit(text3,[25,210])
              pygame.display.update()
            if event.key == K_1:
                playerstatas.money -= 50
                if playerstatas.money < 0:
                    playerstatas.money += 50
                    pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                    text=font.render("所持金が足りない！",True,(0,0,0),30)
        ...
        for event in pygame.event.get():
          ...
          if event.type == KEYDOWN:
            if event.key == K_SPACE:
              ...
              text=font.render("1 回復薬 30G",True,(255,255,255),30)
              screen.blit(text,[25,130])
              pygame.display.update()
            if event.key == K_1:
                playerstatas.money -= 30
                if playerstatas.money < 0:
                  playerstatas.money += 30
                  pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                  text=font.render("所持金が足りない！",True,(0,0,0),30)
                  ...
                  pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                  text=font.render("回復薬を購入した",True,(0,0,0),30)
                  potion += 1
                  screen.blit(text,[110,170])
                  pygame.display.update()
                  time.sleep(1.5)
                  return potion,playerstatas
            if event.key == K_z:
              return

def shop_b():
    global g,playerstatas
    playerstatas.RES = playerstatas.RES-g
    MONEY = str(playerstatas.money)
    while True:
        bouguya=load_image("bouguya.png")
        rect_bouguya=bouguya.get_rect()
        rect_bouguya.move_ip(320,105)
        screen.blit(bouguya,rect_bouguya)
        

        pygame.draw.rect(screen, (0,0,0), (20,375,280,160))
        text=font.render("ここは防具の店だ",True,(255,255,255),30)
        screen.blit(text,[25,400])
        text2=font.render("何を買うかね",True,(255,255,255),30)
        screen.blit(text2,[25,440])
        pygame.display.update()
        ...
        for event in pygame.event.get():
          ...
          if event.type == KEYDOWN:
            if event.key == K_SPACE:
              ...
              screen.blit(text4,[225,25])
              pygame.draw.rect(screen, (0,0,0), (20,125,400,140))
              text=font.render("1 革の鎧 +10 100G",True,(255,255,255),30)
              screen.blit(text,[25,130])
              text2=font.render("2 チェーンメイル +50 500G",True,(255,255,255),30)
              screen.blit(text2,[25,170])
              text3=font.render("3 神装オハン +200 3000G",True,(255,255,255),30)
              screen.blit(text3,[25,210])
              pygame.display.update()
            if event.key == K_1:
                playerstatas.money -= 100
                if playerstatas.money < 0:
                    playerstatas.money += 100
                    pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                    text=font.render("所持金が足りない！",True,(0,0,0),30)
                    ...
                    pygame.display.update()
                    time.sleep(3)
                    return playerstatas,g
                else:
                  g = 10
                  playerstatas.RES = playerstatas.RES+g
                  pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                  text=font.render("革の鎧を購入した",True,(0,0,0),30)
                  screen.blit(text,[110,170])
                  pygame.display.update()
                  time.sleep(1.5)
                return playerstatas,g
            if event.key == K_2:
                playerstatas.money -= 500
                if playerstatas.money < 0:
                    playerstatas.money += 500
                    pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                    text=font.render("所持金が足りない！",True,(0,0,0),30)
                  ...
                  playerstatas.RES = playerstatas.RES+g
                  pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                  text=font.render("チェーンメイルを購入した",True,(0,0,0),30)
                  screen.blit(text,[110,170])
                  pygame.display.update()
                  time.sleep(1.5)
                  return playerstatas,g
            if event.key == K_3:
                playerstatas.money -= 3000
                if playerstatas.money < 0:
                    playerstatas.money += 3000
                    pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                    text=font.render("所持金が足りない！",True,(0,0,0),30)
                  ...
                  playerstatas.RES = playerstatas.RES+g
                  pygame.draw.rect(screen, (255,255,255), (100,150,350,60))
                  text=font.render("神装オハンを購入した",True,(0,0,0),30)
                  screen.blit(text,[110,170])
                  pygame.display.update()
                  time.sleep(1.5)
                  return playerstatas,g
...
def shop_y():
    ...
    MONEY = str(playerstatas.money)
    while True:
        yadoya=load_image("yadoya.png")
        rect_yadoya=yadoya.get_rect()
        rect_yadoya.move_ip(290,105)
        screen.blit(yadoya,rect_yadoya)
        

        pygame.draw.rect(screen, (0,0,0), (20,375,400,280))
        text=font.render("旅人の宿屋へようこそ…",True,(255,255,255),30)
        screen.blit(text,[25,400])
        text2=font.render("宿泊をお望みですか…？",True,(255,255,255),30)
        screen.blit(text2,[25,440])
        pygame.display.update()
        ...
        for event in pygame.event.get():
          ...
          if event.type == KEYDOWN:
            if event.key == K_SPACE:
              pygame.draw.rect(screen, (0,0,0), (20,20,240,60))
              pygame.draw.rect(screen, (0,0,0), (20,125,350,60))
              text=font.render("1泊まる　全回復 20G",True,(255,255,255),30)
              screen.blit(text,[25,130])
              text2 = font.render("所持金",True,(255,255,255),30)
              screen.blit(text2,[25,25])
              text3 = font.render(MONEY,True,(255,255,255),30)
      ...
      if event.type == KEYDOWN:
        ...
        if event.key == K_1:
          while True:
            ...
            text15=font.render("所持金",True,(255,255,255))
            screen.blit(text15,[90,360])
            text16 = font.render(MONEY,True,(255,255,255))
            screen.blit(text16,[200,360])
            text17 = font.render("G",True,(255,255,255))
            screen.blit(text17,[300,360])
            text18 = font.render("回復薬",True,(255,255,255))
...
#町
        ...
        self.images.append([self.sheet3, 2, 1])   # yadoya (21)
        self.images.append([self.sheet3, 3, 1])   # bouguya (22)
...
def main():
    global monsterstatas,X,Y,T1,T2,B,Sound,W,g,playerstatas
    W = 0
    g = 0
    member()
    bigin()
    ...
    while True:
        ...
        if monstertable <= 70:
            monsterstatas = slime()
            X,Y = 100,100
        if monstertable > 70 and monstertable <= 95:
            monsterstatas = wolf()
            X,Y = 160,20
        if monstertable > 95:
            monsterstatas = dragon()
            X,Y = 175,100
        ...
        if player.wx == 37 and player.wy == 120 and pressed_key[K_SPACE]:
            shop_d()
        if player.wx == 52 and player.wy == 120 and pressed_key[K_SPACE]:
            shop_b()
        if player.wx == 25 and player.wy == 119 and pressed_key[K_SPACE]:
            shop_y()
        if player.wx == 25 and player.wy == 119 and pressed_key[K_z]:
            playerstatas.money += 10000
            time.sleep(1)
        if player.wx == 25 and player.wy == 119 and pressed_key[K_c]:
            B = 100
            time.sleep(1)
