...
monstertable = 101
monstertable = False
if monstertable == True:
    monstertable=randint(1,100)
if monstertable <= 100:
    monsterstatas = slime()
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_1:
                    ...
                    if playerstatas.HP <= 0:
                        pygame.draw.rect(screen, (0,0,0), (20,360,480,110))
                        pygame.draw.rect(screen, (0,0,0), (500,360,130,110))
                        text7 = font.render("あなたは倒れた……",True,(255,255,255))
                        screen.blit(text7,[225,370])
                        pygame.display.update()
                        time.sleep(2)
                        gameover()
