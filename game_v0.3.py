...
def charamake():
  ...
  while True:
      ...
      if event.type == KEYDOWN:
          if event.key == K_1:
            ...
            while True:
              ...
              text2=font.render("1男性",True,(0,0,0))
              text3=font.render("2女性",True,(0,0,0))              
    ...
    text2=font.render("1ヒューマン",True,(0,0,0),70)
    text3=font.render("2エルフ",True,(0,0,0),70)
    text4=font.render("3ドワーフ",True,(0,0,0),70)
    text5=font.render("4獣人",True,(0,0,0),70)
    text6=font.render("5植物人",True,(0,0,0),70)
    text7=font.render("6竜人",True,(0,0,0),70)
    text8=font.render("7ウェディ",True,(0,0,0),70)
...
def menu():
  while True:
    ...
    text2=font.render("1ステータス",True,(0,0,0))
...
class Map:
    def __init__(self, screen, filename, player):
        ...
        self.sheet_0 = load_image("pipo-map001.png")
        colorkey = self.sheet_0.get_at((0, 32))
        self.sheet_0.set_colorkey(colorkey, RLEACCEL)
        self.sheet0 = self.sheet_0
        ...
        self.images.append([self.sheet0, 4, 1])  # yama (3)
        self.images.append([self.sheet0, 2, 8])  # mura_left (4)
        self.images.append([self.sheet0, 1, 8])  # mura_right (5)
        self.images.append([self.sheet0, 2, 7])  #town_left (6)
        self.images.append([self.sheet0, 1, 7])  #town_right (7)
